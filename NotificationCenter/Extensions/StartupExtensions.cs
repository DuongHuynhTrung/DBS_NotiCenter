...
namespace NotificationCenter.Extensions
{
    public static class StartupExtensions
    {
        ...
        public static void AddBussinessService(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<ILocationHub, LocationHub>();
            services.AddSingleton<IUserService, UserService>();
            services.AddSingleton<IMessageService, MessageService>();
            services.AddSingleton<IAgoraService, AgoraService>();
                ...
                .AddJwtBearer(jwtconfig =>
                {
                    ...
                    jwtconfig.Events = new JwtBearerEvents()
                    {
                        ...
                        OnMessageReceived = context =>
                        {
                            ...
                            if (path.StartsWithSegments("/locationHub"))
                            {
                                // Read the token out of the query string 
                                context.Token = accessToken;
                            }
        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    Version = "1.1",
                    Description = "Notification center for DBS",
                });

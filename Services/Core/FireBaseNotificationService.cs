        ...
        {
            {
                ...
                try
                {
                    ...
                    if (notificationModel.Title != null && notificationModel.Body != null)
                    {
                    ...
                    {
                        DataPayloadCall dataPayloadCall = new DataPayloadCall();
                        dataPayloadCall.sound = "default";
                        notification.notification = dataPayloadCall;
